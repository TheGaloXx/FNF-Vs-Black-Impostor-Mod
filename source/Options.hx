...
class MiddleScroll extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.middlescroll ? "Middle Scroll" : "No Middle Scroll";
	}
}
...
class AntialiasingOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.antialiasingO = !FlxG.save.data.antialiasingO;
		trace('Antialiasing : ' + FlxG.save.data.antialiasingO);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Antialiasing " + (FlxG.save.data.antialiasingO ? "on" : "off");
}
...
class Mechanics extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.mechanicsO = !FlxG.save.data.mechanicsO;
		trace('Mechanics : ' + FlxG.save.data.mechanicsO);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Mechanics " + (FlxG.save.data.mechanicsO ? "on" : "off");
}